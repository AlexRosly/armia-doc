...
const buildTemplateDataReport = (payload, profile = {}) => {
  ...
  const specialPropertyCasesText = String(
    data.specialPropertyCases?.text || "",
  ).trim();

  const showSpecialPropertyCases = Boolean(specialPropertyCasesText);
  ...
  return {
    ...
    specialPropertyCases: specialPropertyCasesText,
    showSpecialPropertyCases,
