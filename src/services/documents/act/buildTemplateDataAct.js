...
const buildTemplateDataAct = (payload) => {
  ...
  // const grandTotalResidualCostUah = services.reduce(
  //   (sum, service) => sum + toNumber(service.serviceTotalResidualCostUah),
  //   0,
  // );

  // const totalItemsCount = services.reduce(
  //   (sum, service) => sum + (service.items?.length || 0),
  //   0,
  // );
  return {
    //
    ...
    services,
    // totalItemsCount,
    // grandTotalResidualCostUah: String(grandTotalResidualCostUah),
